				...
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
					...
					<?php
					  ...
					  ?>
						...
						<tr>
							<td>Fecha&nbsp;de&nbsp;alta</td>
							<td colspan="2"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" readonly value="<?php echo implota(mysql_result($rs_query,0,"fecha_alta"))?>">
...
//]]></script>	</td>
				      ...
				      <tr>
						  <td>Código Barras</td>
						  <td><input NAME="codigobarras" type="text" class="cajaGrande" id="codigobarras" size="30" maxlength="50" value="<?php echo mysql_result($rs_query,0,"codigobarras")?>"> </td>
				      </tr>					    
						<tr>
							<td>Codigo de barras</td>
							<td colspan="2"><?php echo "<img src='../barcode/barcode.php?encode=EAN-13&bdata=".$codigobarras."&height=50&scale=2&bgcolor=%FFFFFFFF&color=%23333366&type=jpg'>"; ?></td>
						</tr>
				...
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
					  ...
					  <tr>
				        ...
				        <tr><td>Moneda</td><td width="26%">
						 <select name="amoneda" id="moneda" class="cajaPequena2">
						  <?php if (mysql_result($rs_query,0,"moneda")==1) { ?>
					...
					<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
					  <tr>
						  ...
						  <img src="../fotos/<?php echo mysql_result($rs_query,0,'imagen');?>" id="uploadPreview" style="width: 200px; height: 200px;" >
