...
<html>
	<head>
		...
		function imprimir() {
			...
			window.open("../../fpdf/backups.php?e="+e);
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
				<td width="30%" align="left">Nº de respaldos encontrados <input id="filas" type="text" class="cajaMinima" NAME="filas" maxlength="5" readonly></td>
