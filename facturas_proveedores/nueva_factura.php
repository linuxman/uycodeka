...
function pon_prefijo_Fb (codfamilia,pref,nombre,descripcion_corta,precio,codarticulo,moneda) {
	...
	actualizar_importe();
		...
		function validarproveedor(){
			var proveedor=document.getElementById("codproveedor").value;
			var bi=document.getElementById("baseimponible").value;
			if (bi==0 && proveedor != 0) {
				...
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
						<tr>
					      ...
					      <td><input NAME="codproveedor" type="text" class="cajaPequena" id="codproveedor" size="6" maxlength="5" onBlur="validarproveedor()" onFocus="comprobarestado()"></input>
						  ...
						  <td>Cod.&nbsp;Factura</td>
						  <td><input NAME="cfactura" type="text" class="cajaMedia" id="cfactura" size="20" maxlength="20"></input></td>
						<?php $hoy=date("d/m/Y"); ?>
							<td>Fecha</td>
						    <td width="27%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<?php echo $hoy?>"
						     onblur="busco_tipocambio();" onchange="busco_tipocambio();">
						...
						<tr>
							<td>Nombre</td>
						    <td><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" readonly></td>
				            <td>RUT</td>
							...
							<td colspan="4">Tipo&nbsp;cambio
								...
								<input NAME="tipocambio" type="text" class="cajaPequena2" id="tipocambio" size="5" maxlength="5" value="<?php echo $tipocambio; ?>" onchange="cambio();"
								onblur="cambio();"></span>
							</td>
						</tr>
					</table>										
