				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="5%"><div align="center"><a href="#"><img id="botonBusqueda" src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>,<?php echo $marcaestado?>)" title="Modificar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img id="botonBusqueda" src="../img/ver.png" width="16" height="16" border="0" onClick="ver_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>)" title="Visualizar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img id="botonBusqueda" src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>,<?php echo $marcaestado?>)" title="Eliminar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img id="botonBusqueda" src="../img/convertir.png" width="16" height="16" border="0" onClick="convertir_albaran(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>,<?php echo $marcaestado?>)" title="Facturar"></a></div></td>
							<td width="5%"><div align="center"><a href="#"><img id="botonBusqueda" src="../img/imprimir.png" width="16" height="16" border="0" onClick="imprimir_etiquetas(<?php echo mysql_result($res_resultado,$contador,"codalbaran")?>)" title="Imprimir etiquetas"></a></div></td>
						</tr>
						<?php $contador++;
							}
						?>			
