...
function pon_prefijo(codfamilia,pref,referencia,nombre,precio,codarticulo,moneda) {
	parent.pon_prefijo_a(codfamilia,pref,referencia,nombre,precio,codarticulo,moneda);
}
...
<?php if ($nrs>0) { ?>
        ...
        <div align="left"><?php echo $referencia;?></div></td>
					...
					<a href="javascript:pon_prefijo('<?php echo $codfamilia;?>','<?php echo $codigobarras;?>','<?php echo $referencia;?>','<?php echo str_replace('','',$descripcion);?>','<?php echo $precio;?>','<?php echo $codarticulo;?>','<?php echo $moneda;?>');">
