...
$select_facturas="SELECT clientes.codcliente,clientes.nombre,clientes.apellido,clientes.empresa,facturas.codfactura,estado,fechavencimiento,totalfactura,facturas.moneda 
			...
			<div id="zonaContenido">
				...
				<form id="formdatos" name="formdatos" method="post" action="guardar_cobro.php">
					...
					<?php 
						...
						$nombre=mysql_result($rs_facturas,0,"nombre"). ' '. mysql_result($rs_facturas,0,"apellido"). ' / '. mysql_result($rs_facturas,0,"empresa");
						...
						$moneda=mysql_result($rs_facturas,0,"moneda"); 
					...
					?>
						...
						<tr>
						    ...
						    <img src="../img/calendario.png" name="Image11" id="Image11" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Calendario">
						...
						//]]></script>						    
						<img src="../img/disco.png" name="Image2" id="Image2" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Guardar fecha" onClick="cambiar_vencimiento()"></td>
						</tr>
				...
				<form id="formulario" name="formulario" method="post" action="frame_cobros.php" target="frame_cobros">
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0><tr><td valign="top">
						...
						<tr>
						    ...
						    <td ><input id="fechacobro" type="text" class="cajaPequena" NAME="fechacobro" maxlength="10" value="<?php echo $hoy?>" readonly>
					...
					?>
							...
							<td>
									<?php
									if (mysql_result($res_fp,$contador,"resguardo")==1){
									?>
								...
								<input name="tipocambio" class="cajaPequena2" id="tipocambio" size="5" maxlength="5" value="<?php echo $tipocambio; ?>" readonly=""></span>							
							</td>
						</tr>
						<tr>
