...
$rs_lineas=mysql_query($sel_lineas);
						for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
							...
							$descripcion.=' - '. mysql_result($rs_lineas,$i,"detalles");
			...
			<tr><td valign="top" width="80%">
				...
				<div>
					<div align="center">
					  <img id="botonBusqueda" src="../img/botonaceptar.jpg" width="85" height="22" onClick="parent.$('idOfDomElement').colorbox.close();" border="1" onMouseOver="style.cursor=cursor">
