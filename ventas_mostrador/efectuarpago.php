...
if (!empty(mysql_result($rs_clientes,0,"empresa"))) {
	 $nombre_cliente= mysql_result($rs_clientes,0,"empresa");
	} elseif (empty(mysql_result($rs_clientes,0,"apellido"))) {
		$nombre_cliente= mysql_result($rs_clientes,0,"nombre");
	} else { 
		$nombre_cliente= mysql_result($rs_clientes,0,"nombre") .' '. mysql_result($rs_clientes,0,"apellido");
	}
