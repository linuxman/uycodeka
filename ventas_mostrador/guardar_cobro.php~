...
if (mysql_num_rows($rs_comprueba) > 0 ) {
	?>
		...
		$sel_insert="INSERT INTO cobros (id,codfactura,codcliente,importe,moneda,codformapago,numdocumento,fechacobro,observaciones) VALUES ('','$codfactura','$codcliente','$importe','$moneda','$formapago','$numdocumento','$fechacobro','')";
