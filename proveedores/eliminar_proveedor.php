	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
				<table class="fuente8" width="100%" border="0"><tr><td width="50%" valign="top">
				...
				<div>
					<img id="botonBusqueda" src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<?php echo $codproveedor?>)" border="1" onMouseOver="style.cursor=cursor">
