...
headID.appendChild(newScript);
		...
		function ver_tipocambio(codtipocambio) {
			url="ver_tipocambio.php?codtipocambio=" + codtipocambio + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
			window.parent.OpenNote(url);
		}
		
		function modificar_tipocambio(codtipocambio) {
			url="modificar_tipocambio.php?codtipocambio=" + codtipocambio + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
			window.parent.OpenNote(url);
		}
		
		function eliminar_tipocambio(codtipocambio) {
			url="eliminar_tipocambio.php?codtipocambio=" + codtipocambio + "&cadena_busqueda=<?php echo $cadena_busqueda?>";
			window.parent.OpenNote(url);
		}
	...
	<body onload="inicio();">	
		<div id="pagina">
			...
			<div align="center">
			<div class="header">relacion de tipo decambio </div>
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="20%"><div align="center"><?php echo implota(mysql_result($res_resultado,$contador,"fecha"))?></div></td>
							<td width="70%"><div align="center"><?php echo mysql_result($res_resultado,$contador,"valor")?></div></td>
							<td><div><a href="#"><img id="botonBusqueda" src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_tipocambio(<?php echo mysql_result($res_resultado,$contador,"codtipocambio")?>)" title="Modificar"></a></div></td>
							<td><div><a href="#"><img id="botonBusqueda" src="../img/ver.png" width="16" height="16" border="0" onClick="ver_tipocambio(<?php echo mysql_result($res_resultado,$contador,"codtipocambio")?>)" title="Visualizar"></a></div></td>
							<td><div><a href="#"><img id="botonBusqueda" src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_tipocambio(<?php echo mysql_result($res_resultado,$contador,"codtipocambio")?>)" title="Eliminar"></a></div></td>
						</tr>
						<?php $contador++;
							}
						?>			
