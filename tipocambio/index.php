        ...
        <script type="text/javascript">
			  ...
			  <table class="fuente8" width="90%" cellspacing=0 cellpadding=3 border=0>
				...
				<td width="50%" align="center">
					...
					<img id="botonBusqueda" src="../img/botonnuevacotiz.jpg" width="130" height="22" border="1" onClick="nueva_cotiz()" onMouseOver="style.cursor=cursor">
...
Mostrados</td><td> <select name="paginas" id="paginas" onChange="paginar()">
				...
				<div id="lineaResultado">
					<iframe width="300" height="300" id="frame_rejilla" name="frame_rejilla" frameborder="0">
						<ilayer width="300" height="300" id="frame_rejilla" name="frame_rejilla"></ilayer>
					</iframe>
				</div>
			</div>
		  </div>			
